...
                    <div class="w-full py-4 px-0 flex justify-between items-center" style="padding-top: env(safe-area-inset-top);">
                        <div class="flex items-center gap-3">
...
                </header>
                <main id="employee-main-content" class="flex-1 p-0 overflow-y-auto relative z-10"></main>
            </div>
        </div>
    `;
    
